...
def create_new_run(args):
    ...
    if 'rundir' not in list(configuration.keys()):
        print(('Using default run dir of ' + os.getcwd() + '/GA_run/'))
        configuration["rundir"] = os.getcwd() +'/GA_run/'
    if 'queue_type' not in list(configuration.keys()):
    ...
    if not 'liglist' in list(configuration.keys()):
    ...
    ## load geo_check_dict
    if not 'geo_check_dict' in list(configuration.keys()):
    ...
    if not 'genetemplate' in list(configuration.keys()):
    ...
    if 'DFT' in list(configuration.keys()):
    ...
    if 'DFT' in list(configuration.keys()) and 'runtype' in list(configuration.keys()):

...
print(('found ' + str(len(list(converged_jobs.keys()))) + ' converged jobs to check'))


counter = 0
for jobs in list(converged_jobs.keys()):
    ...
    if ahf == 20:
        ...
        if reason in list(outcomes_dictionary.keys()):
...
print('*******')
for keys in list(outcomes_dictionary.keys()):

...
sourcepath=$fullpath
inpath=$generalpath/PRFO_infiles/Oxo/$gennumpath/$namebase.in
outpath=$generalpath/PRFO_outfiles/Oxo/$gennumpath/$namebase.out
scrpath=$generalpath/scr/PRFO/Oxo/$gennumpath/
...
mkdir -p scr
mkdir -p scr/PRFO/
mkdir -p scr/PRFO/Oxo/$gennumpath
spacer='_'
echo "begining"
